  ...
  return (
    <footer className="w-full  text-white px-6 md:px-20 py-12 border-t border-white/10">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        {/* Quick Links */}
        <div>
          <h2 className="lg:text-lg font-semibold mb-2">Quick Links</h2>
          <ul className="space-y-2 text-[1rem] text-neutral-400 ">
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-2 text-xl text-white/70">
            <Link href="https://github.com/VighneshDevHub" target="_blank">
              <SiGithub className="hover:text-white" />
            </Link>
            ...
            <Link href="mailto:vighneshsalunkhe949@gmail.com">
              <FaRegEnvelope className="hover:text-white" />
            </Link>
      ...
      {/* Bottom Bar */}
      <div className="mt-10 border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center lg:text-[0.9rem] text-sm text-white/50">
        <p>
