...
import { SiFlask, SiPostgresql, SiGoogle, SiChatbot, SiShieldsdotio, SiPython, SiFigma, SiHtml5, SiCss3, SiAnaconda, SiVercel, SiOllama, SiOpenai, SiJinja, SiNpm, SiNodedotjs, SiNextdotjs, SiTailwindcss, SiFramer } from "react-icons/si";
...
const content = [
  {
    ...
    tech: [
      ...
      { icon: <SiPostgresql className="w-5 h-5 text-blue-400" />, label: "PostgreSQL" },
      { icon: <SiAnaconda className="text-green-500 w-6 h-6" />, label: "Anaconda" },
      { icon: <SiOllama className="text-white-500 w-6 h-6" />, label: "Ollama" },
      { icon: <SiOpenai className="text-white-500 w-6 h-5" />, label: "OpenAI" },

      { icon: <SiVercel className="text-white w-6 h-6" />, label: "Vercel" },


      { icon: <SiGoogle className="w-5 h-5 text-green-300" />, label: "Google Search API" },
...

  {
    ...
    description: "An AI-powered web platform that detects fake news by extracting key phrases, verifying sources via Google Search, and using LLMs for authenticity scoring. Built with Flask, PostgreSQL, and React.",
    features: [
      { icon: <GoNorthStar className="w-5 h-5  text-purple-600" />, label: "Extracts key phrases from news articles using LLMs to identify the core context." },
      { icon: <GoNorthStar className="w-5 h-5 text-purple-600" />, label: "Uses Google Custom Search API to find real-time references and trusted sources." },
      { icon: <GoNorthStar className="w-5 h-5 text-purple-600" />, label: "Compares the article with external sources using LLMs to generate a truthfulness score." },
      { icon: <GoNorthStar className="w-5 h-5 text-purple-600" />, label: " Persists article data, user logs, and historical results using PostgreSQL." },
    ],
    tech: [
  ...
  },
  {
    ...
    description: "An AI-powered web platform that detects fake news by extracting key phrases, verifying sources via Google Search, and using LLMs for authenticity scoring. Built with Flask, PostgreSQL, and React.",
    features: [
      { icon: <GoNorthStar className="w-5 h-5  text-blue-900 " />, label: "Extracts key phrases from news articles using LLMs to identify the core context." },
      { icon: <GoNorthStar className="w-5 h-5 text-blue-900 " />, label: "Uses Google Custom Search API to find real-time references and trusted sources." },
      { icon: <GoNorthStar className="w-5 h-5 text-blue-900 " />, label: "Compares the article with external sources using LLMs to generate a truthfulness score." },
      { icon: <GoNorthStar className="w-5 h-5 text-blue-900 " />, label: " Persists article data, user logs, and historical results using PostgreSQL." },
    ],
    tech: [

      { icon: <SiNextdotjs className="text-white w-6 h-6" />, label: "Next.js" },
      { icon: <SiTailwindcss className="text-teal-400 w-6 h-6" />, label: "Tailwind CSS" },
      { icon: <SiNodedotjs className="text-green-600 w-6 h-6" />, label: "Node.js", },
      { icon: <SiFigma className="text-purple-500 w-5 h-5" />, label: "Figma" },
